...
public class UpdateUtilitiesActivity extends AppCompatActivity {
    ...
    public void buttonClicked(View v){
        ...
        Intent intent = new Intent(v.getContext(), com.kitetify.me.kitefy.Material.NewUtilitiesActivity.class);
